...
public class Ej10 {
	public static void main(String[] args) {
		...
		if (vuelta<0) {
			...
			int centimos = (int) ((vuelta-euros)*100);
			monedas[0]=euros/2;
			monedas[1]=euros%2;
			...
			System.out.printf("La vuelta son:\n%d monedas de 2€\n%d monedas 1€\n%d monedas de 50cent\n%d monedas de 20cent\n%d monedas de 10 cent\n%d monedas de 5 cent\n%d monedas de 2 cent\n%d monedas de 1 cent",monedas[0],monedas[1],monedas[2],monedas[3],monedas[4],monedas[5],monedas[6],monedas[7]);
		};
